...
2. Describe what it means to be mobile first vs desktop first.
    ...
    -You design what your site would like on a mobile phone first then you would use media querie to design for larger screen sizes(desktops)


3. What does `font-size: 62.5%` in the `html` tag do for us when using `rem` units?

   -1rem = 10px for easy unit conversions and the default font size of the site remains at the expected default of 16px.
...
5. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?
    ...
    -Yea!: Nesting
    -Nah: Not knowing all the unique syntax that are available to use, on the fly.
